...
public class Entity {
    ...
    @JsonProperty("user_mentions")
    public List<UserMention> getUserMentions() { return user_mentions; }

    @JsonProperty("user_mentions")
    public void setUserMentions(List<UserMention> user_mentions) { this.user_mentions = user_mentions; }
}
