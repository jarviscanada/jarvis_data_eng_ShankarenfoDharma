...
public interface LambdaStreamExc {
     ...
     * @param strings 0+ String params, or an array of strings
     ...
     * use createStrStream
     * @param strings 0+ String params, or an array of strings
     * @return a stream with uppercase strings
     */
    Stream<String> toUpperCase(String ... strings);

    /**
     * filter strings that contains the pattern (only pass strings that has no match with pattern)
     * filter(stringStream, "a") will return another stream which no element containing a
     * @param stringStream original stream
     * @param pattern target regex to take out
     * @return stream without pattern
     */
     ...
     * @return lambda that does printer
     */
     ...
     * msg:c!
     *
     * @param messages datas to print
     * @param printer the lambdaPrinter to use
     */
     ...
     * odd number:5!
     *
     * @param intStream result of createIntStream(range)
     * @param printer result of getLambdaPrinter
     */
     ...
     *   - using flatMap
     *
     * @param ints numbers to be squared
     * @return Stream of integer results
     */
